...
export default function BloodDonationEligibility() {
  ...
  const onFinish = async (values) => {
    setLoading(true);
    try {
      // Bỏ kiểm tra điều kiện, luôn cho phép hiến máu
      ...
      const surveyData = {
        ...
        overallEligibility: 'du_dieu_kien',
        deferralReason: null
      };

      // Gửi dữ liệu lên server
      await donorAPI.createSurvey(surveyData);
      ...
      message.error('Có lỗi xảy ra khi lưu kết quả khảo sát');
    } finally {
      setLoading(false);
    }
  };
