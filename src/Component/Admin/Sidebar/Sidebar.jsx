...
const menu = [
  ...
  { label: 'Quản lý đơn yêu cầu máu', path: '/admin/blood-requests' },
  { label: 'Quản lý tin tức', path: '/admin/news' },
  { label: 'Quản lý cơ sở y tế', path: '/admin/medical-facilities' },
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-header">
        ...
        <div>
          <div className="sidebar-name">Admin Nguyen</div>
