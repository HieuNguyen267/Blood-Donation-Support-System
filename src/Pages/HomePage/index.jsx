...
export default function HomePage() {
  ...
  const handleSearch = () => {
    if (selectedDate) {
      ...
      // Optional: alert the user to select a date
      alert("Vui lòng chọn ngày để đặt lịch.");
    }
  };
  ...
  return (
    <>
      ...
      <div className="homepage-wrapper">
        ...
        {/* Các hoạt động hiến máu */}
        <section className="activities">
          <h2 className="activities-title">Các hoạt động hiến máu nhân đạo</h2>
          <div className="activities-gallery">
            <div className="gallery-card">
              <div className="gallery-title">Tình người hiến máu giữa đại dịch</div>
              <div className="gallery-date">04/08/2021</div>
              <img src="/images/hoatdong.jpg" alt="Hoạt động " />
            </div>
          </div>
        </section>
      </div>
